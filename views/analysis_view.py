...
class AnalysisView(tk.Frame):
    ...
    def _create_widgets(self):
        ...
        self.cast_tree.pack(fill=tk.BOTH, expand=True, pady=(5,0))
        self.rename_button = tk.Button(self.cast_list_outer_frame, text="Rename Selected Speaker", command=self.app_controller.rename_speaker); self.rename_button.pack(fill=tk.X, pady=(5,0))
        self.resolve_button = tk.Button(self.cast_list_outer_frame, text="Resolve Ambiguous (AI)", command=self.app_controller.logic.start_pass_2_resolution); self.resolve_button.pack(fill=tk.X)
